...
import CustomerListToolbar from "./ProductListToolbar";
import CustomerListHead from "./ProductListHead";
import CustomerSearchNotFound from "./ProductSearchNotFound";
import CustomerMoreMenu from "./ProductMoreMenu";
import AddProduct from "./AddProductT";
import axios from "axios";
import config from "../../Utils/config";
const TABLE_HEAD = [
  { id: "Product_name", label: "પ્રોડક્ટ નામ", alignRight: false },
  { id: "Hsn_code", label: "HSN Code", alignRight: false },
  { id: "Product_unit", label: "યુનિટ", alignRight: false },
  { id: "Product_price", label: "ભાવ", alignRight: false },
  { id: "Previous_stock", label: "આગળ નો સ્ટોક", alignRight: false },
  { id: "Minimum_stock", label: "મિનિમમ સ્ટોક", alignRight: false },
  { id: "Maximum_stock", label: "મહત્તમ સ્ટોક", alignRight: false },
...
function applySortFilter(array, comparator, query) {
  ...
  if (query) {
    return filter(
      array,
      (_user) =>
        _user.Product_name.toString()
          .toLowerCase()
          .indexOf(query.toLowerCase()) !== -1 ||
        _user.Hsn_code.toString().toLowerCase().indexOf(query.toLowerCase()) !==
          -1 ||
        _user.Product_unit.toString()
          .toLowerCase()
          .indexOf(query.toLowerCase()) !==
          -1 - 1 ||
        _user.Product_price.toString()
          .toLowerCase()
          .indexOf(query.toLowerCase()) !== -1
    );
  }
...
export default function ProductTable() {
  ...
  const [orderBy, setOrderBy] = useState("Hsn_code");
                    ...
                    .map((row) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="left">{Product_price}</TableCell>
                          <TableCell align="left">{Previous_stock}</TableCell>
                          <TableCell align="left">{Minimum_stock}</TableCell>
                          <TableCell align="left">{Maximum_stock}</TableCell>
      ...
      <div>
        ...
        >
          <DialogTitle id="alert-dialog-title" className="modalHeaderFlex">
            <p className="">{isEdit ? "અપડેટ પ્રોડક્ટ " : "એડ પ્રોડક્ટ  "}</p>
