...
import CustomerSearchNotFound from "./CustomerSearchNotFound";
...
const TABLE_HEAD = [
  ...
  { id: "Cutomer_route", label: "રુટ", alignRight: false },
  { id: "C_name", label: "Name", alignRight: false },
  { id: "N_name", label: "Nick Name", alignRight: false },
  { id: "Mobile_number1", label: "મોબાઇલ નંબર", alignRight: false },
  ...
  if (query) {
    return filter(
      ...
      (_user) =>
        ...
        _user.Mobile_number1.toLowerCase().indexOf(query.toLowerCase()) !==
          -1 ||
        _user.N_name.toLowerCase().indexOf(query.toLowerCase()) !== -1 ||
        (_user.Order_number &&
          _user.Order_number.toString()
            .toLowerCase()
...
export default function CustomerTable() {
  ...
  const getCustomers = () => {
    try {
      axios
        .get(`${config.BaseURL}/api/customer/list`, {})
        .then((response) => {
                    ...
                    .map((row) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="left">{N_name}</TableCell>
                          <TableCell align="left">{Mobile_number1}</TableCell>
